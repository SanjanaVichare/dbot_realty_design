  ...
  return (
    <nav
      style={{
        ...
        right: 0,
        zIndex: 1000,
        background: scrolled ? "rgba(0,18,64,0.96)" : "#001240",
    ...
    >
      ...
      >
        ...
        <a href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 600, color: "#F4F7FC", letterSpacing: "-0.01em" }}>
            DBOT
          </span>
        </a>
          ...
          {links.map((link) => (
            <a
              ...
              style={{
                ...
                padding: "8px 14px",
                borderRadius: 10,
                background: link.active ? "rgba(14,85,165,0.28)" : "transparent",
...
/* ─── Footer ─────────────────────────────────────────────── */
function Footer() {
  const preServices = ["Due Diligence", "Consulting & Valuations", "ESG Consulting", "Feasibility Studies", "Financial Modelling"];
  const otherServices = ["PMC", "Project Management", "Mandate Selling", "ESG Consulting (Post)"];
  const company = ["About Us", "Our Team", "Careers", "Projects", "Contact"];
  ...
  return (
    <footer style={{ background: "#001240", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "64px 32px 0" }}>
        ...
        >
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
              ...
              <span style={{ fontSize: 17, fontWeight: 600, color: "#F4F7FC" }}>DBOT</span>
            </div>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.42)", lineHeight: 1.8, maxWidth: 255, marginBottom: 26 }}>
              End-to-end real estate advisory across the complete project lifecycle — from due diligence to post-completion ESG.
            </p>
            <div style={{ display: "flex", gap: 9 }}>
              {["LI", "TW", "IG"].map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLAnchorElement).style.background = "rgba(14,85,165,0.4)";
                    (e.currentTarget as HTMLAnchorElement).style.color = "#fff";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLAnchorElement).style.background = "rgba(255,255,255,0.06)";
          ...
          {/* Pre-Construction */}
          <div>
            <p style={{ fontSize: 11, fontWeight: 600, color: "#56A018", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 18 }}>
              Pre-Construction
            </p>
            {preServices.map(footerLink)}
          </div>
        ...
        >
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.28)" }}>
            © {new Date().getFullYear()} DBOT Real Estate Advisory. All rights reserved.
          </p>
